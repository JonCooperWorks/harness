...
func (k *KeychainKeystore) GetPublicKey(keyID string) (*ecdsa.PublicKey, error) {
...
func (k *KeychainKeystore) DecryptSymmetricKey(keyID string, encryptedKey []byte) ([]byte, error) {
