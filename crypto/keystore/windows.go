...
func (w *WindowsKeystore) GetPrivateKey(keyID KeyID) (ed25519.PrivateKey, error) {
...
func (w *WindowsKeystore) SetPrivateKey(id KeyID, privateKey ed25519.PrivateKey) error {
...
func (w *WindowsKeystore) PublicEd25519(id KeyID) (ed25519.PublicKey, error) {
	privateKey, err := w.GetPrivateKey(id)
	if err != nil {
		return nil, err
	}
...
func (w *WindowsKeystore) PublicX25519(id KeyID) ([32]byte, error) {
	privateKey, err := w.GetPrivateKey(id)
	if err != nil {
		return [32]byte{}, err
	}
...
func (w *WindowsKeystore) SignDigest(id KeyID, digest []byte) ([]byte, error) {
	privateKey, err := w.GetPrivateKey(id)
	if err != nil {
		return nil, err
	}
...
func (w *WindowsKeystore) ECDH(id KeyID, peerPublic [32]byte) (sharedSecret [32]byte, err error) {
	privateKey, err := w.GetPrivateKey(id)
	if err != nil {
		return [32]byte{}, err
	}
...
func (w *WindowsKeystore) ListKeys() ([]KeyID, error) {
